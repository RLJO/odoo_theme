                ...
                rpc.query({
                    ...
                    if(data && data[0] && data[0].name){
                        ...
                        if(getSelCats == undefined || getSelCats == ''){
                            self.$target.empty().append('<div class="container"><div class="seaction-head"><h2>No Category Selected!</h2></div></div>');
                        }else{
                            self.$target.attr('data-slider-style-name',collection_name);
                            self.$target.empty().append('<div class="container"><div class="seaction-head"><h2>Category Product Slider: '+ collection_name  +'</h2></div></div>');
                        }
